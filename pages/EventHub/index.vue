    ...
    <div class="container">
      ...
      <div class="row gx-0 mb-5">
        ...
        <div class="col-lg-8 col-md-auto">
          ...
          <div class="py-5 my-5 d-none d-lg-flex" id="Unlock"></div>
          ...
          <div class="py-5 my-5 d-none d-lg-flex" id="Event"></div>
          ...
          <div class="py-5 my-5 d-none d-lg-flex" id="Imagine"></div>
