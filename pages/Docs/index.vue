            ...
            <div class="row gx-0">
              <p class="fw-lighter display-5 lh-base pb-3">
                ...
                <a
                  ...
                  class="link-btnsearch"
                  >http://localhost:8000/swagger-ui.html</a
                >
...
import SideBarLeftMobileVue from "~~/components/SideBarLeftMobile.vue";

export default {
  return: {},
  components: { SidebarLeft, SidebarRight, Downloadnow, SideBarLeftMobileVue },
};
</script>
