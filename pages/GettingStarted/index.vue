  ...
  <div>
      ...
      <div class="col-6">
        <div class="row">
          ...
          <div class="warningBox p-4">
            <p class="fw-lighter display-5 lh-base">
              <strong>Note Apple M1 users:</strong> the standard keycloak image
              in the docker compose file does not yet support the Apple M1 ARM
              based architecture. Therefore you need to replace the keycloak
        ...
        <div class="row">
          ...
          <p class="fw-lighter display-5 lh-base">
            ...
            >
            called the Pet Store Events API. You can replace this or edit it to
            reflect your own Webhook API details. Alternatively, you can just
          ...
          />
          <p class="fw-lighter display-5 lh-base">
            When you click <strong>Publish</strong> , the API will be available,
            to discover and subscribe, to any users within the consumer groups
            you selected.
          </p>
          <img
            src="../../assets/images/webhook-page-1024x589 1.svg"
        ...
        <div class="row">
          ...
          <ul class="fw-lighter display-5 list-unstyled">
            ...
            <li class="pt-3 ps-5 lh-base">
              ...
              logical container for the callbacks associated with it. It should
              reflect the name of the application that hosts the callback.
            </li>
            <li class="pt-3 ps-5 lh-base">
              ...
              HMAC signature (if you need a few more security options check out
            ...
            <li class="pt-3 ps-5 lh-base">
              5.<strong>Test</strong> the Subscription – Webhookie will send the
              example request body to your callback. If you get a 2XX response
              from your callback then you are good to proceed.
            </li>
            <li class="pt-3 ps-5 pb-3 lh-base">
              6.<strong>Activate</strong> the Subscription – your callback will
              now start receiving traffic when the events occur.
            </li>
          </ul>
        ...
        <div class="row">
          ...
          <ul class="fw-lighter display-5 list-unstyled">
            ...
            webhookie. These are:
            <li class="pt-3 ps-5 lh-base">
              <strong>AMQP</strong> – If you have RabbitMQ or any other message
              bus within your architecture you can use it to send events to
              webhookie.
              <nuxt-link to="" class="text-decoration-none link-btnsearch">
            ...
            <li class="pt-3 ps-5 pb-4 lh-base">
              <strong>API</strong> – If you don’t have a message bus within your
              architecture then we have a simple REST API to post events to
              webhookie.<nuxt-link
                to=""
                class="text-decoration-none link-btnsearch"
              >
    ...
    username=webhookie_admin&password=passwd1&grant_type=password
            ...
            <li class="pt-3 ps-5">
              ...
              <strong>createdPet</strong> event – see the wh-topic header).1.Get
              a token to publish events to webhookie
              <div class="text-white bg-codesample p-4 m-4">
                <pre>
    POST /ingress/event 
    HTTP/1.1
    ...
    Your test message
          ...
          <p class="fw-lighter display-5 lh-base pb-3">
            ...
            below (note: you must extract the json file from the zip file before
            you import it into Postman).
          </p>
          <button
            type="button"
        ...
        <div class="row">
          ...
          <p class="fw-lighter display-5 lh-base">
            If you navigate to Traffic in the webhookie developer portal you can
