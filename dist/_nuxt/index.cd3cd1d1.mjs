...
\r
    ...
    Authorization: Bearer &lt;bearer token&gt;\r
\r
              </code></pre></div></div>`,8),_={class:"row gx-0 pb-5"},x={class:"col"},A=t("button",{type:"button",class:"btn btn-outline-btnsearch px-4"}," Get started ",-1),P=t("div",{class:"col text-right"},[t("button",{type:"button",class:"btn btn-outline-btnsearch px-4 ms-4"}," Road map ")],-1),k={class:"col-3"};function I(q,T,W,H,R,C){const i=s,r=g,l=o,n=a;return p(),d("div",null,[t("div",w,[t("div",v,[t("div",f,[e(i)]),t("div",m,[y,t("div",_,[t("div",x,[e(r,{to:"/GettingStarted"},{default:h(()=>[A]),_:1})]),P])]),t("div",k,[e(l)])])]),e(n,{class:"my-5"})])}const B=c(b,[["render",I]]);export{B as default};
