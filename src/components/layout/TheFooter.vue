  ...
  <div class="pt-3 container">
    <div class="row gx-0 justify-content-center">
        ...
        <div class="row px-0">
          <div class="col-lg-4 col-md-auto mb-5">
            <div class="col">
              ...
              <nav class="nav">
                <a class="nav-link link-icon px-1" href="https://github.com/webhookie">
                  <svg
                  ...
                  >
                    ...
                    /></svg
                ></a>
                <a class="nav-link link-icon" href="https://twitter.com/webhookie">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                  ...
                  >
                    ...
                    /></svg
                ></a>
                <a class="nav-link link-icon px-1" href="https://linkedin.com/company/webhookie">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                  ...
                  >
                    ...
                    /></svg
                ></a>
                <a class="nav-link link-icon" href="https://medium.com/webhookie">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                  ...
                  >
                    ...
                    /></svg
                ></a>
                <a class="nav-link link-icon px-1" href="https://facebook.com/webhookie">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
            ...
            <div class="row">
              <div class="col-lg-4 mt-2 col-md-auto mb-5">
                ...
                <nav class="nav flex-column">
                  <a class="nav-link link-icon display-6 fw-light" href="/Docs/GettingStarted"
                    >Install</a
                  >
                  <a
                    class="nav-link link-icon display-6 fw-light"
                    href="/Docs/Overview"
                    >Documentation</a
                  >
                  <!--<a class="nav-link link-icon display-6 fw-light" href=""
                    >Features</a
                  >-->
                </nav>
              </div>
              ...
              <div class="col-lg-4 mt-2 col-md-auto">
                ...
                <nav class="nav flex-column">
                  <a
                    ...
                    >Event Hub</a
                  >
                  <a class="nav-link link-icon display-6 fw-light" href="https://community.webhookie.com"
                    >Community</a
                  >
                  <a
                    class="nav-link link-icon display-6 fw-light"
      ...
      <p class="text-center py-5 display-6 fw-light opacity-75">
        Copyright © 2023 Webhookie. All rights reserved
      </p>
    </div>
  </div>
</template>
