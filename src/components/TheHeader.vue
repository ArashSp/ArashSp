    ...
    >
      <div class="row container justify-content-center">
        ...
        >
          ...
          >
            <li>
              <a class="dropdown-item display-7 pb-1" href="https://github.com/webhookie"
                >GITHUB</a
              >
            </li>
            <li>
              <a class="dropdown-item display-7 pb-1" href="/Docs/Overview"
                >DOCS</a
              >
            </li>
            <li>
              <a class="dropdown-item display-7 pb-1" href="https://community.webhookie.com"
                >COMMUNITY</a
              >
            </li>
            <li>
              <a class="dropdown-item display-7 pb-1" href="/HowItWorks"
                >HOW IT WORKS</a
              >
            </li>
            <li>
              <a class="dropdown-item display-7 pb-1" href="/EventHub"
                >EVENT HUB</a
              >
            </li>
            <li>
              <a class="dropdown-item display-7 pb-1" href="/Blog"
                >BLOG</a
              >
            </li>
            <li>
              <a class="dropdown-item display-7 pb-1" href="/useCases"
                >USE CASES</a
              >
            </li>
          </ul>
        ...
        >
          <div class="navbar-nav mt-1 text-center">
            ...
            >
            <a
              class="nav-link ms-2 display-7 fw-light lh-sm navtop"
              href="/Docs/Overview"
            >
              DOCS</a
            >
            <a class="nav-link ms-2 display-7 fw-light lh-sm navtop" href="https://community.webhookie.com">
              COMMUNITY</a
            >
            <a
              class="nav-link ms-2 display-7 fw-light lh-sm navtop"
            ...
            >
            <a
              class="nav-link mx-2 display-7 fw-light lh-sm navtop"
              href="/useCases"
            >
              USE CASES</a
            >
