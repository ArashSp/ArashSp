  ...
  <div class="bg-blackBg text-white">
          ...
          <div class="row gx-0 justify-content-center">
            ...
            <div class="col-lg-6 col-md-auto text-center">
              <a href="/Docs/Overview">
                <button type="button" class="btn btn-primary mb-5 display-7 fw-bold buttonsCustom"
    ...
    <div class="row gx-0 justify-content-center">
      <div class="text-center">
        ...
        <img src="/images/webhookie.gif" class="mt-5 mb-5 pb-5" style="width: 60%; height: 85%" />
      </div>
    </div>
    ...
    <div class="container">
      <div class="row gx-0">
        <div class="col-12 text-center">
          <img src="/images/microservice.svg" class="mb-3 pb-5" style="max-width: 100%" />
    ...
    <div class="bg-primary text-center spacer display-2" style="padding-top: 80px; padding-bottom: 80px">
      <div class="Notrotate">
        ...
        <a href="/Docs/GettingStarted">
          <button type="button" class="btn btn-primary rounded-2 my-3 display-7 fw-bold buttonsCustom">
            DOWNLOAD NOW
          </button>
        </a>
      </div>
        ...
        <div class="">
          ...
          <div class="row gx-lg-6 mb-5 mt-5">
            <div class="col-lg col-md-auto">
              ...
              <p class="display-3 fw-bold lhtitle">Audit logs</p>
              <p class="display-5 fw-lighter lhBody">
...
.RTDBox {
  background: linear-gradient(149.48deg,
